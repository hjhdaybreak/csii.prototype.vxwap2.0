...
(function(window, vx, $, undefined) {
	...
	var services = {};
	services.uiSliderbar = ["$os", "$compile",
	function($os, $compile) {
		var sliderBar;
		var defaults = {
			title : "贷款金额",
		...
		return {
			resetSliderbar : function(opt, element) {
				var options = $.extend({}, defaults, opt),template="";
	...
	function(uiSliderbar, $timeout) {
		...
		return {
			...
			link : function(scope, element, attr) {
				var options = $.extend({}, vx.fromJson(attr.uiSliderbar || {}));
