 ...
 * Copyright (c) 2015 CSII; Licensed : BSD */
window._Chart = {}, window._Chart.fn1 = function() {"use strict";
	...
	var d = c.helpers = {}, e = d.each = function(a, b, c) {
		...
		return 0 !== a % 1 && o(a) ? a.toString().split(".")[1].length : 0
		...
		for (var k = Math.abs(i - j), l = u(k), m = Math.ceil(i / (1 * Math.pow(10, l))) * Math.pow(10, l), n = d ? 0 : Math.floor(j / (1 * Math.pow(10, l))) * Math.pow(10, l), o = m - n, r = Math.pow(10, l), s = Math.round(o / r); (s > g || g > 2 * s) && !h; )
			if (s > g)
				r *= 2, s = Math.round(o / r), 0 !== s % 1 && ( h = !0);
			else if (e && l >= 0) {
				if (0 !== r / 2 % 1)
					break;
		...
		easeInOutElastic : function(a) {
			var b = 1.70158, c = 0, d = 1;
			return 0 === a ? 0 : 2 == (a /= .5) ? 1 : (c || ( c = 1 * .3 * 1.5), d < Math.abs(1) ? ( d = 1, b = c / 4) : b = c / (2 * Math.PI) * Math.asin(1 / d), 1 > a ? -.5 * d * Math.pow(2, 10 * (a -= 1)) * Math.sin((1 * a - b) * 2 * Math.PI / c) : .5 * d * Math.pow(2, -10 * (a -= 1)) * Math.sin((1 * a - b) * 2 * Math.PI / c) + 1)
		},
	...
	c.instances = {}, c.Type = function(a, b, d) {
		...
		destroy : function() {
			...
			a.width = this.chart.width, a.height = this.chart.height, a.style.removeProperty ? (a.style.removeProperty("width"), a.style.removeProperty("height")) : (a.style.removeAttribute("width"), a.style.removeAttribute("height")),
		...
		save : function() {
			...
			delete this._saved._saved, this
		},
		update : function(a) {
...
}, window._Chart.fn6 = function() {"use strict";
...
}, window._Chart.fn5 = function() {"use strict";
	var a = this, b = a.Chart, c = b.helpers, d = {
		segmentShowStroke : !0,
...
}, window._Chart.fn4 = function() {"use strict";
	var a = this, b = a.Chart, c = b.helpers, d = {
		scaleShowGridLines : !0,
		scaleGridLineColor : "rgba(0,0,0,.05)",
		scaleGridLineWidth : 1,
...
}, window._Chart.fn3 = function() {"use strict";
	var a = this, b = a.Chart, c = b.helpers, d = {
...
}, window._Chart.fn2 = function() {"use strict";
